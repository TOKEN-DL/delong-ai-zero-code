...
public class WebScreenshotUtils {
    ...
    //全局静态初始化
    static {
        final int DEFAULT_SCREEN_WIDTH = 1920;
        final int DEFAULT_SCREEN_HEIGHT = 1080;
        webDriver = initChromeDriver(DEFAULT_SCREEN_WIDTH, DEFAULT_SCREEN_HEIGHT);
    }
    ...
    public static String saveWebPageScreenshot(String webUrl){
        ...
        try {
            ...
            //截图
            byte[] screenshotBytes =((org.openqa.selenium.TakesScreenshot) webDriver).getScreenshotAs(OutputType.BYTES);
            //保存原始图片
    ...
    private static void waitForPageLoad(WebDriver webDriver) {
        try {
            ...
            // 等待 document.readyState为complete
