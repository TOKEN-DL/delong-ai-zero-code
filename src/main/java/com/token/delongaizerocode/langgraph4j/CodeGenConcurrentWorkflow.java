package com.token.delongaizerocode.langgraph4j;
...
import com.token.delongaizerocode.langgraph4j.node.*;
import com.token.delongaizerocode.langgraph4j.node.concurrent.*;
...
public class CodeGenConcurrentWorkflow {
    ...
    public WorkflowContext executeWorkflow(String originalPrompt) {
        ...
        int stepCounter = 1;
        // 配置并发执行
        ExecutorService pool = ExecutorBuilder.create()   // 创建线程池，适配并发操作
                .setCorePoolSize(10)
                .setMaxPoolSize(20)
        ...
        RunnableConfig runnableConfig = RunnableConfig.builder()
                .addParallelNodeExecutor("image_plan", pool) // 从哪个节点开始进行并发
                .build();
