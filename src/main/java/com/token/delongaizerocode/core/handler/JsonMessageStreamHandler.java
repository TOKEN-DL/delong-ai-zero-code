...
import com.token.delongaizerocode.ai.tools.BaseTool;
import com.token.delongaizerocode.ai.tools.ToolManager;
        ...
        switch (typeEnum) {
            ...
            case TOOL_REQUEST -> {
                ...
                if (toolId != null && !seenToolIds.contains(toolId)) {
                    ...
                    return tool.generateToolRequestResponse();   //返回给前端
                } else {
                    // 不是第一次调用这个工具，直接返回空
                    return "";
                }
